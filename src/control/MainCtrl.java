	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(ac.equals("login"))
		{
			...
			if(!pagerandom.equals(random)&&request.getParameter("a")!=null)
			{
				...
				if(utype.equals("高层领导")){sql1 = "select * from gaocenglingdao where yonghuming='"+username+"' and mima='"+password+"' ";}
				if(utype.equals("员工")){sql1 = "select * from yuangongxinxi where gonghao='"+username+"' and mima='"+password+"' ";}
