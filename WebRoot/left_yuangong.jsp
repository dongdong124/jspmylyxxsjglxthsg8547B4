...
<dl class="custom">
			...
			<dd><a href="yuangongxinxi_updt2.jsp" target="hsgmain">修改个人资料</a></dd>
...
<dd><a href="xinxiyunweifuwu_list1.jsp" target="hsgmain">运维服务查询</a></dd>

		</dl>
<dl class="custom">
			<dt onClick="changeImage()">项目管理<img src="images/left/select_xl01.png"></dt>
			
<dd><a href="xiangmuxinxi_list1.jsp" target="hsgmain">项目查询</a></dd>
